                ...
                <form action="#">
                    ...
                    <div class="row">
                        <div class="col-xl-6 col-md-6">
                            ...
                            <div class="ml-2 custom-control mt-1 custom-checkbox">
                                <input type="checkbox" class="custom-control-input ml-3" id="customCheck2" />
                                <label class="custom-control-label" for="customCheck2">Service 2</label>
                            </div>
                            <div class="ml-2 custom-control mt-1 custom-checkbox">
                                <input type="checkbox" class="custom-control-input ml-3" id="customCheck3" />
                                <label class="custom-control-label" for="customCheck3">Service 3</label>
                            </div>
                            <div class="ml-2 custom-control mt-1 custom-checkbox">
                                <input type="checkbox" class="custom-control-input ml-3" id="customCheck4" />
                                <label class="custom-control-label" for="customCheck4">Service 4</label>
                            </div>
                            <div class="ml-2 custom-control mt-1 custom-checkbox">
                                <input type="checkbox" class="custom-control-input ml-3" id="customCheck5" />
                                <label class="custom-control-label" for="customCheck5">Service 5</label>
                            </div>
                        </div>
                        <div class="col-xl-6 col-md-6">
