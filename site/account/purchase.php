    ...
    <?php if (!empty($order)) : ?>
      <div class="order mt-5">
        <?php foreach ($order as $o) : ?>
          ...
          <?php foreach (list_all_purchase($customer['id'], $o['id']) as $all) : ?>
   ...
   <?php if (!empty(custom_order_status($customer['id'],'Chờ lấy hàng'))) : ?>
      <div class="order mt-5">
        <?php foreach ($order_wait as $o) : ?>
          <?php foreach (order_status($customer['id'],$o['id'], 'Chờ lấy hàng') as $all) : ?>
            <div class="row border-bottom pb-2 mb-3">
              <div class="col-2">
                <a href="<?= ROOT ?>?page=detail&id=<?= $all['id_product'] ?>"> <img src="<?= ROOT ?>images/products/<?= $all['images'] ?>" alt="" width="80" height="80"></a>
              </div>
   ...
   <?php if (!empty(custom_order_status($customer['id'],'Đang giao'))) : ?>
      <div class="order mt-5">
        <?php foreach ($order_delivery as $o) : ?>
          <?php foreach (order_status($customer['id'],$o['id'], 'Đang giao') as $all) : ?>
            <div class="row border-bottom pb-2 mb-3">
              <div class="col-2">
                <a href="<?= ROOT ?>?page=detail&id=<?= $all['id_product'] ?>"> <img src="<?= ROOT ?>images/products/<?= $all['images'] ?>" alt="" width="80" height="80"></a>
              </div>
   ...
   <?php if (!empty(custom_order_status($customer['id'],'Đã giao'))) : ?>
      <div class="order mt-5">
        <?php foreach ($order_delivered as $o) : ?>
          <?php foreach (order_status($customer['id'],$o['id'], 'Đã giao') as $all) : ?>
            <div class="row border-bottom pb-2 mb-3">
              <div class="col-2">
                <a href="<?= ROOT ?>?page=detail&id=<?= $all['id_product'] ?>"> <img src="<?= ROOT ?>images/products/<?= $all['images'] ?>" alt="" width="80" height="80"></a>
              </div>
   ...
   <?php if (!empty(custom_order_status($customer['id'],'Đã hủy'))) : ?>
      <div class="order mt-5">
        <?php foreach ($order_cancel as $o) : ?>
          <?php foreach (order_status($customer['id'],$o['id'], 'Đã hủy') as $all) : ?>
            <div class="row border-bottom pb-2 mb-3">
              <div class="col-2">
                <a href="<?= ROOT ?>?page=detail&id=<?= $all['id_product'] ?>"> <img src="<?= ROOT ?>images/products/<?= $all['images'] ?>" alt="" width="80" height="80"></a>
              </div>
